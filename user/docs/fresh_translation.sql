...
--
-- Host: localhost
-- Generation Time: Jul 15, 2011 at 03:55 AM
...
('Your actual password', 'Ihr aktuelles Passwort', 'de', 'yum'),
('Your actual password', 'Votre mot de passe actuel', 'fr', 'yum'),
('Your actual password', 'La tua password corrente', 'it', 'yum'),
('Your actual password is not correct', 'Ihr aktuelles Passwort ist nicht korrekt', 'de', 'yum'),
('Your actual password is not correct', 'Votre mot de passe actuel n est pas correct', 'fr', 'yum'),
('Your actual password is not correct', 'La tua password corrente non ̬ corretta', 'it', 'yum'),
