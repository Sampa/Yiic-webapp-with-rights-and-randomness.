...
return array(
  ...
  '{attribute} must include at least {num} symbols.' => '{attribute} musi zawierać co najmniej {num} symboli.',
  '{attribute} is too short (min. {num} characters).' => '{attribute} jest zbyt krótki (min. {num} znaków).',
  '{attribute} is too long (max. {num} characters).' => '{attribute} jest zbyt długi (max. {num} znaków).',
